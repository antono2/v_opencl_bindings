...
OpenCL 1.0 through 1.2 scalar aliases, opaque handles, and structures are selected
from the feature requirements and generated by resolving their XML typedef
chains to V ABI types.
OpenCL 1.0 through 1.2 command declarations and inline V wrappers are generated
