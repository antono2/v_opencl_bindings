...
OpenCL 1.0 through 2.1 scalar aliases, opaque handles, and structures are selected
from the feature requirements and generated by resolving their XML typedef
chains to V ABI types.
OpenCL 1.0 through 2.1 command declarations and inline V wrappers are generated
